...
Notably, butterfly \emph{without} noise-aware training achieves better robustness ($0.377 \pm 0.032$) than Clements \emph{with} it (0.281).
...
\caption{Clean accuracy versus mesh size $N$ on vowel. $N{=}32$ was run for Clements and butterfly only. At $\sigma{=}0.1$ (not shown), the gap widens further in butterfly's favor.}
\label{fig:scaling}
\end{figure}
